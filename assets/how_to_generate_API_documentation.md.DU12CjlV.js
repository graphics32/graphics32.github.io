...
<span class="line"><span></span></span>
<span class="line"><span>Below is the complete, canonical list of all Pascal source units in \`Source/\`. AI agents and maintainers must use this checklist when populating or auditing API documentation coverage:</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>- [ ] **GR32.Blend.Assembler** (document only at unit level)</span></span>
...
<span class="line"><span>- [ ] **GR32.Blend.Pascal** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32.Blend.SSE2** (document only at unit level)</span></span>
...
<span class="line"><span>- [ ] **GR32.ImageFormats.PSD.Model** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32.ImageFormats.PSD.Reader** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32.ImageFormats.PSD.Types** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32.ImageFormats.PSD.Writer** (document only at unit level)</span></span>
...
<span class="line"><span>- [ ] **GR32.Text.Cache** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32.Text.FontFace** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32.Text.Layout** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32.Text.Types**</span></span>
<span class="line"><span>- [ ] **GR32.Text.Unicode** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32.Text.Win** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32.Transpose**</span></span>
<span class="line"><span>- [ ] **GR32.Types.SIMD** (document only at unit level)</span></span>
...
<span class="line"><span>- [ ] **GR32_Backends_LCL_Carbon** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_Backends_LCL_CustomDrawn** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_Backends_LCL_Gtk** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_Backends_LCL_Win** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_Backends_VCL** (document only at unit level)</span></span>
...
<span class="line"><span>- [ ] **GR32_Polygons.AggLite** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_Polygons.Direct2D** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_Polygons.GDI** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_Polygons.GDIPlus** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic**</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.IDAT** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.PLTE** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.Unknown** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.bKGD** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.cHRM** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.gAMA** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.hIST** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.iCCP** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.iTXt** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.oFFs** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.pCAL** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.pHYs** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.sBIT** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.sCAL** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.sPLT** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.sRGB** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.tEXt** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.tIME** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.tRNS** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Chunks.zTXt** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Encoding** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Transcoding** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.Types** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_PortableNetworkGraphic.ZLib** (document only at unit level)</span></span>
...
<span class="line"><span>- [ ] **GR32_VectorUtils.Angus** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_VectorUtils.Clipper2** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **GR32_VectorUtils.Reference** (document only at unit level)</span></span>
<span class="line"><span>- [ ] **amEasing**</span></span>
<span class="line"><span></span></span>
<span class="line"><span>The following files will not be documented. Either because they are externals (copied from other libraries) or because they are internal to Graphics32.</span></span>
...
<span class="line"><span>- **Clipper.RectClip**</span></span></code></pre></div>`,8))])}const C=i(t,[["render",m]]);export{E as __pageData,C as default};
